...
model_name = "tiny_LLaMA_7b"
#name = "tinyllama_1b_cwd10B"
#name="tinyllama_1b_dsirdomain10B"
# name = "tinyllama_1b_contriever20_2000"
# name = "tinyllama_1b_contriever10b2"
#name = "tinyllama_1b_doremi"
name = "tinyllama_7b_full"
#name = "tinyllama_1b_qrating_full"
#name = "tinyllama_1b_uniform1_100"
#name = "tinyllama_1b_dsir1_100"
out_dir = Path("out") / name
...
def setup(
    ...
    if devices > 1:
        ...
        strategy = "auto"
    #strategy = "auto"
    fabric = L.Fabric(devices=devices, strategy=strategy, precision=16, loggers=[logger, wandb_logger])
...
def train(fabric, state, train_dataloader, val_dataloader, monitor, resume):
    ...
    for  train_data in train_dataloader:
        ...
        if (state['iter_num']% show_interval == 0):
            fabric.print(
